...
<head>
    ...
    <!-- Plugin CSS -->
    <link rel="stylesheet" href="{{ asset('assets/css/css2/dropify.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/css2/sweetalert2.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/css2/animate.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/css2/select2.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/css2/daterangepicker.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/css2/jquery.toast.min.css') }}">
    ...
    <!-- App CSS -->
    <link rel="stylesheet" href="{{ asset('assets/css/css2/styles.css') }}">

    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ asset('assets/css/css2/all.min.css') }}">
...
<body class="sb-nav-fixed">
        ...
        <div class="container-fluid">
            <div>
                ...
                <a class="navbar-brand text-md-center"
                    href="{{ route('dashboard') }}">Digital Crystal Global Fin. </a>
            </div>
                ...
                <ul class="navbar-nav ml-auto ml-md-0">
                    <li class="nav-item dropdown animate-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right card" aria-labelledby="userDropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('profile_setting') }}">
                                <i class="fa-solid fa-gear me-2"></i> Account Settings
                            </a>

                            <a class="dropdown-item"
                                href="{{ route('update_password') }}">
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="payment_request" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link"
                                    href="{{ route('request_payment') }}">New
                                    Request</a>
                                <a class="nav-link"
                                    href="{{ route('request_payment_history') }}">All Requests</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="deposit" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link"
                                    href="{{ route('cheque_deposit_page') }}">
                                    Cheque Deposit</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="withdraw" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link"
                                href="{{ route('crypto_withdrawal_page') }}">Crypto Withdrawal</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="loans" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="{{ route('request_loan') }}">Apply New Loan</a>
                                <a class="nav-link" href="{{ route('loan_history') }}">My Loans</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="fdr" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link"
                                    href="{{ route('fixed_deposit') }}">Apply New
                                    FDR</a>
                                <a class="nav-link"
                                    href="{{ route('fixed_deposit_history') }}">FDR
                                    History</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="tickets" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link"
                                    href="{{ route('support_ticket') }}">Contact
                                    Customer Service</a>
                                <a class="nav-link"
                                    href="#">Pending
                                    Tickets</a>
                        ...
                        <a class="nav-link" href="{{ route('profile_setting') }}">
    ...
    _smartsupp.key = '3c1a400648f304a016a2789e2bf8cf6709348a7d';
