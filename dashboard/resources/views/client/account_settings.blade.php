                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 auto-select" data-selected="1" name="country_code" required>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="phone" value="234234234234" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="control-label">Image (300 X 300)</label>
                                    <input type="file" class="form-control dropify" data-default-file="https://account.starbasefinancebanking.com/public/uploads/profile/default.png" name="profile_picture" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG">
                                </div>
                            </div>

                            <div class="col-12">
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary btn-block"><i class="icofont-check-circled"></i> Update Profile</button>
                                </div>
                            </div>
                        </div>
                    </form>
