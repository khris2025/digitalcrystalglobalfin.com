         ...
         <div data-simplebar class="h-100">
            <div id="sidebar-menu">
               <ul class="metismenu list-unstyled" id="side-menu">
                  ...
                  <li>
                     <a href="{{ route('pending_transaction') }}">
                  ...
                  {{-- <li>
                     ...
                     <i data-feather="credit-card"></i>
                     <span data-key="t-dashboard">Transactions History</span>
                     </a>
                  </li> --}}
                  <li>
      ...
      <div class="main-content">
         <div class="page-content">
            <div class="container-fluid">
               ...
               <p style="font-size: 20px">welcome, {{ Auth::user()->fullname }}</p>
                     ...
                     <div class="card card-h-100 text-white" style="height: 220px; background-color: #4f1f65; border-radius: 10px; padding: 10px;">
                        ...
                        <div class="card-body">
                           <div class="d-flex flex-column align-items-start">
                              <!-- Checking Balance -->
                              <div class="mb-3">
                                 <p style="margin: 0; font-weight: bold; color: #b5a3be">{{ Auth::user()->accounttype }}</p>
                                 <h2 style="margin: 0; color: white">$ {{ number_format(Auth::user()->accbalance, 2) }}</h2>
                              </div>
                              <!-- Account Number -->
                              <div class="mb-2">
                                 <p style="margin: 0; color: #b5a3be">ACCOUNT NUMBER</p>
                                 <p style="margin: 0;">{{ Auth::user()->account_number }}</p>
                              </div>
                              <!-- Account Status -->
                              <div class="mb-3">
                                 <p style="margin: 0; color: #b5a3be">ACCOUNT STATUS</p>
                                 <p style="margin: 0;">{{ Auth::user()->account_status }}</p>
                              </div>
...
_smartsupp.key = '978c94cba40b258668a23ebcddf795633692952e';
