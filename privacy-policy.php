...
<!-- Mirrored from HTBbank.ltd/privacy-policy by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Apr 2023 14:43:05 GMT -->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarmain">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a class="nav-link btn-outline-red mr-lg-2" href="https://users.digitalcrystalglobalfin.com/login"><i class="icofont-lock"></i> Sign In</a></li>
                                                <li class="nav-item"><a class="nav-link btn-signup mr-lg-2" href="https://users.digitalcrystalglobalfin.com/register"><i class="icofont-ui-user"></i> Sign Up</a></li>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="languageSelector">
                                                                    <a class="dropdown-item" href="indexfa27.html?language=English">English</a>
                                                            </ul>
                        </li>
                    </ul>
                </div>
...
<p>However, if necessary, we may retain your personal information for our compliance with a legal, accounting, or reporting obligation or for archiving purposes in the public_data interest, scientific, or historical research purposes or statistical purposes.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 col-sm-6">
                    <div class="widget mb-5 mb-lg-0">
                        ...
                        <div class="divider mb-4"></div>
                        <ul class='list-unstyled footer-menu lh-35'><li class="nav-item"><a target="_self" href="privacy-policy.html" class='active ' > Privacy Policy </a></li><li class="nav-item"><a target="_self" href="terms-condition.html" class=' ' > Terms & Condition </a></li><li class="nav-item"><a target="_self" href="faq.html" class=' ' > FAQ </a></li> </ul>
                    </div>
                </div>
            </div>
